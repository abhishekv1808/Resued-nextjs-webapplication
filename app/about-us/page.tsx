    ...
    return (
        <>
            ...
            <main className="flex-grow">
                {/* Hero Section */}
                <section className="bg-[#a51c30] text-white py-12 md:py-20 relative overflow-hidden">
                    ...
                    <div className="max-w-6xl mx-auto px-4 relative z-10 text-center">
                        ...
                        <p className="text-lg md:text-2xl font-light text-red-100 mb-6 md:mb-8">
                ...
                <section className="py-10 md:py-16 bg-white">
                    <div className="max-w-4xl mx-auto px-4 text-center">
                        <p className="text-gray-600 text-xs md:text-lg leading-relaxed mb-4 md:mb-6">
                            At <span className="font-bold text-[#a51c30]">SimTech Computers</span>,
                        ...
                        <p className="text-gray-600 text-xs md:text-lg leading-relaxed mb-4 md:mb-6">
                            ...
                            <span className="font-bold text-[#a51c30]">Simtech Computers</span> has
                            ...
                            <table className="w-full text-left border-collapse min-w-[600px]">
                                <thead>
                                    <tr className="bg-gray-100 border-b border-gray-200">
                                        ...
                                        <th className="p-3 md:p-4 font-bold text-[#a51c30] bg-red-50">SimTech Computers</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-100 text-sm">
                                    <tr>
                                        ...
                                        <td className="p-3 md:p-4 text-gray-900 font-medium bg-red-50">Factory-tested and certified</td>
                                    </tr>
                                    <tr>
                                        <td className="p-3 md:p-4 font-medium text-gray-900">Warranty</td>
                                        <td className="p-3 md:p-4 text-gray-500">3–6 months limited</td>
                                        <td className="p-3 md:p-4 text-gray-900 font-medium bg-red-50">1-Year Warranty on all products</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td className="p-3 md:p-4 text-gray-900 font-medium bg-red-50">30-Day Replacement Guarantee</td>
                                    </tr>
                                    <tr>
                                        <td className="p-3 md:p-4 font-medium text-gray-900">Pricing</td>
                                        <td className="p-3 md:p-4 text-gray-500">High markups</td>
                                        <td className="p-3 md:p-4 text-gray-900 font-medium bg-red-50">Up to 70% less than retail</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <section className="py-12 md:py-20 bg-gray-900 text-white text-center relative overflow-hidden">
                    ...
                    <div className="max-w-4xl mx-auto px-4 relative z-10">
                        ...
                        <a href="/" className="inline-block bg-[#a51c30] hover:bg-red-600 text-white font-bold py-3 px-8 rounded-full transition-transform hover:scale-105 shadow-lg">
