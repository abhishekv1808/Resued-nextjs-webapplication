        ...
        <>
            ...
            <main className="container mx-auto px-4 py-8 max-w-7xl">
                ...
                <div className="text-center mb-12">
                    <span className="inline-block px-3 py-1 bg-blue-50 text-[#0a2e5e] rounded-full text-xs font-bold tracking-wide uppercase mb-3">
                        Resources
                    </span>
                    <h1 className="text-4xl font-bold text-gray-900 mb-4 font-heading">Our Blog</h1>
                    <p className="text-gray-600 max-w-2xl mx-auto">Stay updated with the latest tech trends, buying guides, and news from Reused.</p>
                </div>
                                ...
                                <div className="p-6 flex flex-col flex-1">
                                    <div className="flex items-center gap-4 text-xs text-gray-500 mb-3">
                                        <span className="flex items-center gap-1">
                                            <i className="ri-calendar-line text-[#0a2e5e]"></i>
                                            {new Date(blog.date).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
                                        </span>
                                        <span className="flex items-center gap-1">
                                            <i className="ri-user-3-line text-[#0a2e5e]"></i>
                                            {blog.author}
                                        </span>
                                    </div>
                                    <h2 className="text-xl font-bold text-gray-900 mb-3 line-clamp-2 hover:text-[#0a2e5e] transition-colors leading-tight font-heading">
                                    ...
                                    <Link href={`/blogs/${blog._id}`} className="inline-flex items-center text-[#0a2e5e] font-bold text-sm hover:underline mt-auto uppercase tracking-wide">
