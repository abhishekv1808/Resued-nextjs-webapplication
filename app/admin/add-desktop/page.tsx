        ...
        <div className="max-w-[1600px] mx-auto">
            <div className="bg-[var(--admin-card)] rounded-xl border border-[var(--admin-border)] shadow-sm">
                <div className="px-6 py-4 border-b border-[var(--admin-border)] flex items-center justify-between">
                    <h2 className="text-xl md:text-3xl font-bold text-[var(--admin-text-main)] font-heading">Add New Desktop</h2>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <select name="brand" defaultValue="" className="w-full pl-10 bg-[var(--admin-hover)] border border-[var(--admin-border)] text-[var(--admin-text-main)] rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#29abe2] focus:ring-1 focus:ring-[#29abe2] transition-colors appearance-none" required>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="text" name="name" className="w-full pl-10 bg-[var(--admin-hover)] border border-[var(--admin-border)] text-[var(--admin-text-main)] rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#29abe2] focus:ring-1 focus:ring-[#29abe2] transition-colors" placeholder="e.g. Dell OptiPlex 7090 Micro" required />
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="text" name="processor" className="w-full pl-10 bg-[var(--admin-hover)] border border-[var(--admin-border)] text-[var(--admin-text-main)] rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#29abe2] focus:ring-1 focus:ring-[#29abe2] transition-colors" placeholder="e.g. Intel Core i5 12400" required />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <select name="ram" defaultValue="" className="w-full pl-10 bg-[var(--admin-hover)] border border-[var(--admin-border)] text-[var(--admin-text-main)] rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#29abe2] focus:ring-1 focus:ring-[#29abe2] transition-colors appearance-none" required>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <select name="storage" defaultValue="" className="w-full pl-10 bg-[var(--admin-hover)] border border-[var(--admin-border)] text-[var(--admin-text-main)] rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#29abe2] focus:ring-1 focus:ring-[#29abe2] transition-colors appearance-none" required>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="text" name="graphics" className="w-full pl-10 bg-[var(--admin-hover)] border border-[var(--admin-border)] text-[var(--admin-text-main)] rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#29abe2] focus:ring-1 focus:ring-[#29abe2] transition-colors" placeholder="e.g. Integrated or GTX 1660" />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <select name="os" defaultValue="Windows 10" className="w-full pl-10 bg-[var(--admin-hover)] border border-[var(--admin-border)] text-[var(--admin-text-main)] rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-[#29abe2] focus:ring-1 focus:ring-[#29abe2] transition-colors appearance-none">
