...
export default function AddDesktop() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            formData.append('category', 'desktop');
            ...
            formData.append('processor', (form.elements.namedItem('processor') as HTMLInputElement).value);
            formData.append('ram', (form.elements.namedItem('ram') as HTMLSelectElement).value);
            formData.append('storage', (form.elements.namedItem('storage') as HTMLSelectElement).value);
            formData.append('graphics', (form.elements.namedItem('graphics') as HTMLInputElement).value);
            formData.append('os', (form.elements.namedItem('os') as HTMLSelectElement).value);
            ...
            if (response.ok) {
                setToast({ message: 'Desktop added successfully!', type: 'success' });
                setTimeout(() => router.push('/admin/products'), 1500);
            } else {
                const data = await response.json();
                setToast({ message: data.error || 'Failed to save desktop', type: 'error' });
            }
        } catch (error) {
            console.error('Error saving desktop:', error);
            setToast({ message: 'An error occurred while saving the desktop', type: 'error' });
        } finally {
            setSubmitting(false);
        }
    };
        ...
        <div className="max-w-[1600px] mx-auto">
            <div className="bg-[var(--admin-card)] rounded-xl border border-[var(--admin-border)] shadow-sm">
                <div className="px-6 py-4 border-b border-[var(--admin-border)] flex items-center justify-between">
                    <h2 className="text-3xl font-bold text-[var(--admin-text-main)] font-heading">Add New Desktop</h2>
                ...
                <form onSubmit={handleSubmit} className="p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <select name="brand" defaultValue="" className="w-full pl-10 bg-[var(--admin-hover)] border border-[var(--admin-border)] text-[var(--admin-text-main)] rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-colors appearance-none" required>
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-[var(--admin-text-muted)] uppercase tracking-wider mb-2">Desktop Name</label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                            <i className="ri-computer-line text-gray-400"></i>
                                        </div>
                                        <input type="text" name="name" className="w-full pl-10 bg-[var(--admin-hover)] border border-[var(--admin-border)] text-[var(--admin-text-main)] rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-colors" placeholder="e.g. Dell OptiPlex 7090 Micro" required />
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="text" name="processor" className="w-full pl-10 bg-[var(--admin-hover)] border border-[var(--admin-border)] text-[var(--admin-text-main)] rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-colors" placeholder="e.g. Intel Core i5 12400" required />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <select name="ram" defaultValue="" className="w-full pl-10 bg-[var(--admin-hover)] border border-[var(--admin-border)] text-[var(--admin-text-main)] rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-colors appearance-none" required>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <select name="storage" defaultValue="" className="w-full pl-10 bg-[var(--admin-hover)] border border-[var(--admin-border)] text-[var(--admin-text-main)] rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-colors appearance-none" required>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="text" name="graphics" className="w-full pl-10 bg-[var(--admin-hover)] border border-[var(--admin-border)] text-[var(--admin-text-main)] rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-colors" placeholder="e.g. Integrated or GTX 1660" />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <select name="os" defaultValue="Windows 10" className="w-full pl-10 bg-[var(--admin-hover)] border border-[var(--admin-border)] text-[var(--admin-text-main)] rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-colors appearance-none">
                    ...
                    <div className="pt-6 mt-6 border-t border-[var(--admin-border)] flex justify-end gap-3">
                        ...
                        <button type="submit" disabled={submitting} className="px-6 py-2 rounded-lg bg-red-600 hover:bg-red-700 text-white text-sm font-bold shadow-lg shadow-red-900/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed">
                            {submitting ? 'Saving...' : 'Save Desktop'}
                        </button>
                    </div>
                </form>
            </div>
