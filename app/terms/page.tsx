    ...
    return (
        <>
            ...
            <main className="container mx-auto px-4 py-8 max-w-4xl">
                <h1 className="text-3xl font-bold mb-6 text-red-900">Terms and Conditions</h1>

                <div className="bg-white p-8 rounded-lg shadow-sm prose prose-red max-w-none">
                    <p className="mb-4">Last updated: {new Date().toLocaleDateString()}</p>

                    <h2 className="text-xl font-semibold mt-6 mb-3">1. Agreement to Terms</h2>
                    <p>These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (`"you"`) and Simtech Computers (`"we,"` `"us"` or `"our"`), concerning your access to and use of the simtechcomputers.in website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the `"Site"`).</p>
                    ...
                    <h2 className="text-xl font-semibold mt-6 mb-3">3. User Representations</h2>
                    ...
                    <h2 className="text-xl font-semibold mt-6 mb-3">4. Products</h2>
                    ...
                    <p className="mt-2">
                        <strong>Simtech Computers</strong><br />
                        Bangalore, India<br />
                        Email: support@simtechcomputers.in
                    </p>
                </div>
            </main>
            <Footer />
