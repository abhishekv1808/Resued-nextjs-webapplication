          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="mb-6">
                ...
                <p className="text-sm md:text-base text-gray-400 leading-relaxed">
                  Bangalore&apos;s premium destination for{" "}
                  <strong>Fresh Corporate Pulls</strong>. We sell only
                  factory-original used laptops with zero soldering and zero
                  substituted parts. Just Original DNA.
                </p>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3 group">
                  ...
                  <div>
                    ...
                    <a
                      href="tel:+918147867701"
                      className="text-white font-bold text-lg hover:text-[#29abe2] transition-colors block"
                    >
                      +91 81478 67701
                    </a>
                  </div>
                ...
                <div className="flex items-start gap-3 group">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-white text-sm hover:text-[#29abe2] transition-colors"
                    >
                      support@reused.in
                    </a>
                  </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 mb-6">
                Follow us for latest updates, exclusive deals, and tech
                insights.
              </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-center md:text-left">
              ...
              <p className="text-[10px] text-gray-500 mt-1">
                Made with <i className="ri-heart-fill text-red-500"></i> in
                Bangalore
              </p>
            </div>
